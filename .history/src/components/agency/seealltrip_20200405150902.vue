      ...
      <div class="columns is-multiple">
        <div class="column is-4">
          <ul v-for="item in rowData1" :key="item.id">
            <div class="infos">
            <div >    <i class="fas fa-user-shield"></i>  {{item.from}}-{{item.to}}</div>
           <div >    <i class="fas fa-user-shield"></i>  {{item.title}}</div>
           <div >    <i class="fas fa-user-shield"></i>   {{item.blogger}}</div>
           </div>
