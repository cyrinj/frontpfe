      ...
      <div class="columns is-multiple">
        <div class="column is-4">
          <ul v-for="item in rowData1" :key="item.id">
             <i class="fas fa-user-shield"></i>  <div >{{item.from}}-{{item.to}}</div>
             <i class="fas fa-user-shield"></i>  <div >{{item.title}}</div>
            <i class="fas fa-user-shield"></i>   <div >{{item.blogger}}</div>
