...
<div id="agency_signup">
  <div class="content">
      <div class="m field is-grouped is-grouped-multiline">
 ...
 <input list="browsers" name="browser">
  ...
  <option value="Internet Explorer">aa</option>
    <option value="Firefox">x</option>
    <option value="Chrome">y</option>
    <option value="Opera">z</option>
    <option value="Safari">e</option>
                    </datalist>
                  </div>
