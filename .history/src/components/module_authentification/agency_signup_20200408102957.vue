...
<div id="agency_signup">
  ...
  <form v-on:submit.prevent="userRegister" >
     ...
     <button class="button is-info is-rounded next1" @click.prevent="next1()">Next</button>
  ...
  <select class="select is-fullwidth">
    <option class="is-fullwidth">Agecny </option>
    <option class="is-fullwidth">Local Guid</option>
  </select>
</div> 
                 <div class="field">
                  <div class="control">
