...
export default {
    ...
    mounted(){
       ...
       console.log("ggg",this.rowData)
         axios.post('http://localhost:3000/api/v2/host/allinfotrip',{id:this.rowData[0].tripid}).then(response => {
       this.rowData[0].trip = response.data.data;
       console.log("ggg",this.rowData[0].trip)
