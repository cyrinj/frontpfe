    ...
    <div class="DivWithScroll">
      ...
      <div class="dropdown-container">
        <router-link to="/model">
          <button class="dgh">
            <span class="icon has-text-success e3">
              <i class="fas fa-journal-whills e3"></i>
            </span>Trip form
          </button>
        </router-link>
        <router-link to="/formactivity">
          <button class="dgh">
            <span class="icon has-text-success e3">
              <i class="fas fa-bullseye e3"></i>
            </span>Hosting activity
          </button>
        </router-link>
          <router-link to="/tripdrafts">
          <button class="dgh">
            <span class="icon has-text-success e3">
              <i class="fas fa-pencil-ruler e3"></i>
            </span>Drafts
          </button>
        </router-link>
      </div>
      ...
      <div class="dropdown-container">
        <router-link to="/editprofil" v-if="user.role=='tripper'">
          <button class="dgh">
            <span class="icon has-text-success e3">
