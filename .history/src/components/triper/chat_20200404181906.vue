...
<template>
<div>
  <button class="reafficher box-shadow-x" @click="reafficher()">Wantotrip Admin&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
 <div class="cadre_status box-shadow-x" v-show="x">
...
.chatbox2 {
  ...
  flex-direction: column;
  list-style-type: none;
  background-color: rgb(215, 138, 235);
  color: rgb(255, 253, 253);
 text-align: left;
  width: 20vw;
  height: 30px;
