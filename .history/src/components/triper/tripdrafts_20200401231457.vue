<template>
  <div id="status">
    ...
    <span class="titlestyle">  <strong>{{obj.title}} </strong> </span>
         <span>{{obj.date_suggestion[0]}}{{obj.date_suggestion[1]}}{{obj.date_suggestion[2]}}{{obj.date_suggestion[3]}}{{obj.date_suggestion[4]}}{{obj.date_suggestion[5]}}{{obj.date_suggestion[6]}}{{obj.date_suggestion[7]}}{{obj.date_suggestion[8]}}{{obj.date_suggestion[9]}}</span>  </div>   
        <div class="supp">       
<button class="br" @click="supprimer(obj)"><i class="fa fa-calendar-check has-text-success "></i></button>  
