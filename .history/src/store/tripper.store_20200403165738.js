import { editprofilDonneesService,tripsdraftsService, tripstatusService, tripdeleteService, tripupdateService, tripsuggestService, editprofilService, changepassword_inService } from '@/api/tripper.service.js'
...
export default {
    ...
    actions: {
       ...
       //editer les donnees
        async  editprofildonnees(context,user) {
            console
            let usernew = await editprofilDonneesService(user)
