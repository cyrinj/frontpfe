...
import agency_signup from '@/components/module_authentification/agency_signup'
...
import editprofilagency from '@/components/agency/editprofilagency'
  ...
  routes: [
    ...
    }, 
    {
      ...
      children:[
        ...
        {
          path: "/editprofilagency",
          name: "editprofilagency",
          component: editprofilagency,
        },
        {
